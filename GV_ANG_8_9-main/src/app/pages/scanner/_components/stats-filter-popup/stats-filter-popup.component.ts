import { Component, OnInit, Input, ViewChildren, QueryList, AfterViewInit, ViewChild, OnDestroy, Output, EventEmitter } from '@angular/core';
...
export class StatsFilterPopupComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  @Input() modal;
  @Output()
  applyFilters = new EventEmitter<string>();
  type_left = 'left';
  type_right = 'right';
  filterdata: Filter;
  ...
  constructor(private readonly _store: StateService, private _plannerService: PlannerService) {
    this._setVariables();
    this._getLeagues();
  }
  ...
  applyStrategyFilters(): void {
    this._store.setFilters(true);
